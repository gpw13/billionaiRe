...
style_hpop_timeseries <- function(df, wb, sheet_name, start_row, start_col, ind,
  ...
  openxlsx::addStyle(wb,
    sheet = sheet_name, style = excel_styles()$hpop_main_data_header,
  ...
  openxlsx::addStyle(wb,
    sheet = sheet_name, style = excel_styles()$hpop_sec_data_header_border_right_align,
...
#' Styles UHC time series
#'
#' @inheritParams write_hpop_timeseries_sheet
#' @inherit style_header_hpop_summary_sheet
#' @param df_wide wide version of `df` generated by `write_uhc_timeseries_sheet`

style_uhc_timeseries <- function(df, wb, sheet_name, start_row, start_col, ind,
                                 year, type_col, df_wide, ind_df) {
  mergeCellForced(wb,
    sheet = sheet_name,
    cols = start_col, rows = start_row:(start_row + 1)
  ...
  openxlsx::addStyle(wb,
    sheet = sheet_name, style = excel_styles()$uhc_sec_data_header_border_right_align,
    rows = c((start_row + 1)), cols = c((start_col + 1):(ncol(df_wide) + 1)),
    gridExpand = TRUE
  )
  openxlsx::addStyle(wb,
  ...
  openxlsx::addStyle(wb,
    sheet = sheet_name,
    style = excel_styles()$normal_text_bold,
