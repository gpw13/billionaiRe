...
- `scenario_linear_percent_change`: change by a fixed percentage point from a baseline value by target year. Done in percentage points.
- `scenario_linear_percent_change_col`: change by a fixed percentage point from a baseline value by target year, with the percentage change value provided in a column and not as a a single value. This allow for instance to have a different change for every country, indicator and year combinationss. Done in percentage points.
