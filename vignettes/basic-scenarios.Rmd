...
The basic scenarios are the building blocks the other scenarios use. They can also be used by themselves onto the data.

Each of those scenarios have share parameters, but also have their own. See the individual documentation for each function to see the details.
