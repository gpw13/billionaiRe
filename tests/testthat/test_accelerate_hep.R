...
testthat::test_that("espar returns appropriate values", {
  df <- tidyr::expand_grid(
    ...
    year = 2018:2020,
    ind = billion_ind_codes("hep")["espar"]
  ) %>%
    dplyr::mutate(
      value = c(
        35, 13, 20, 20, 0, 60, 60, 60, 80, 20, 40, 40, 20, 60, 80, 80, 80, 40, 27, 20, 20, 40, 40, 60),
      type = "reported",
      scenario = "default",
  ...
  testthat::expect_equal(df_accelerated_2025, c(47.5, 20.0, 40.0, 60.0, 60.0, 80.0, 42.333333, 40.0))
